...
/**
 * strict (по умолчанию) — для запуска сервера: в production без адреса сайта
 * и контактов клиники ошибка. strict: false — для разметки страниц, которую
 * Next частично строит ещё при сборке, без боевого окружения.
 */
